        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    rectuteurId = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Offers",
                columns: new[] { "Id", "ApplicationUserId", "ApplicationUserId1", "Company", "DateLine", "DatePub", "Description", "Location", "Poste", "Profil", "Qualifications", "Remuneration", "Responsibilities", "Secteur", "Type", "rectuteurId" },
                values: new object[] { 1, null, null, "SAMITEC", new DateOnly(2024, 5, 6), new DateOnly(2024, 5, 25), "ghybfbjfiueghfyefnv dyy", "Casablanca", "Web Developer", 3, "FVUBYIZy dgyghf", "2335 - 4566$", "fuluihu fh", "Informatique", 1, "a997231b-4176-4538-a452-952056dd30e3" });
